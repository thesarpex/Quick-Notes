                ...
                <div className='flex flex-col items-center mb-6'>
                    ...
                    <form>
                        ...
                        <div>
                            ...
                            <input id='password-confirm' type='password' value={passwordConfirm} className='w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500' placeholder='***********' required />
                            </div>
